...
export default function MonitorFrame({ children }: MonitorFrameProps) {
  ...
  useEffect(() => {
    const update = () => {
      ...
      setPadding({
        top: isMobile ? vh * 0.03 : vh * 0.09,
        bottom: isMobile ? vh * 0.03 : vh * 0.09,
        left: isMobile ? vw * 0.02 : vw * 0.075,
        right: isMobile ? vw * 0.02 : vw * 0.075,
      });
    };
    update();
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          padding: "clamp(3dvh, 9dvh, 9dvh) clamp(2dvw, 7.5dvw, 7.5dvw)",
